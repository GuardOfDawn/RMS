		  ...
		  <div id="content">
		    <form>
	          <div class="form_settings" style="margin-top:100px;margin-left:100px">
	          	<p>
	          	  <span style="width:300px;font-size:20px;">查看特定时间段内识别最多的风险</span>
	          	</p>
	          	<br>
	          	<br>
	          	<p><span>起始日期</span>
	        ...
	        <%RiskConditionBean riskList = (RiskConditionBean)request.getAttribute("mostAddedRisks");
		    ...
		    <div>
			    ...
			    JFreeChart chart = ChartFactory.createPieChart("风险被识别数的比例图",dpd, true, false, false);
...
function getRiskStat(){
	...
	if(startDateString=="选择日期"||endDateString=="选择日期"){
		...
		window.location.href='<%=path%>/RiskMostAddedStatServlet?startDate='+startDateString+'&endDate='+endDateString;
	}
}
</script>
</html>